...
//        
//        tableView.register(FriendRequestCell.self, forCellReuseIdentifier: SettingsController.cellId)
//        tableView.register(RequestHeader.self, forHeaderFooterViewReuseIdentifier: SettingsController.headerId)
    }
...
//        let header = tableView.dequeueReusableHeaderFooterView(withIdentifier: SettingsController.headerId) as! RequestHeader
//        
//        if section == 0 {
